      ...
      >
        {experienceData.map((exp) => (
          ...
          >
              ...
              <span className="text-slate-500 dark:text-slate-400 font-medium text-[14px] md:text-[15px] tracking-wide mb-1">
                {exp.link ? (
                  <a 
                    ...
                    className="text-blue-600 hover:text-blue-700 hover:underline dark:text-blue-400 dark:hover:text-blue-300 font-semibold flex items-center gap-1 w-fit"
                  >
                    {exp.company}
                  </a>
                ) : (
            ...
            {exp.link && (
              <div className="mb-6 relative z-10 flex text-left">
                <a 
                  href={exp.link}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-full text-xs font-semibold shadow-sm transition-all hover:scale-[1.03] active:scale-[0.97]"
                >
